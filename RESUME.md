...
> 本次会话存档点（2026-06-07，★6 第三刀完成 → 过程间污点三刀：RETURN 摘要 + within-file param-sink + 跨文件 param-sink）。本文件 + 自动记忆（`formal-atlas-subsystem.md`）共同记录"我停在哪、下一步做什么"。
...
```bash
cd formal-atlas
npm test                                                  # 9 smoke + 22 engines(★2/★3/★4/★6) + MCP 16-工具自检，全绿
...
## 下一步：★1–★4 主线 + ★6 三刀已完成，余为"按需"的规模/精度工程（06-frontier-map 5–8）
